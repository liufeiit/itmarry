...
import com.guide.geek.app.AppException;
import com.guide.geek.bean.Notice;
import com.guide.geek.bean.Update;
...
//	}	
	 ...
	 * @return
	 */
	public static User userList(AppContext appContext) throws AppException {
		try{

			return Update.parse(http_get(appContext, URLs.UPDATE_VERSION));		
			Update update = null;//为能运行暂时设计，后期需要修改
			return  update;
