...
public class LoginActivity extends Activity {
	...
	private Animation anim_down_appearce,anim_up_gone;
	...
	public void login_user(View view){
		if (LOGIN_STATE == R.string.login_state_pre){
			...
			if (Judege(user,pass)){
				final Intent intent = new Intent(LoginActivity.this,ContronActivity.class);
				password.clearComposingText();

				String host = account.getText().toString(); 
