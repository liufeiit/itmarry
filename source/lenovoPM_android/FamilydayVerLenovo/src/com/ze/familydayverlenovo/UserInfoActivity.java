...
public class UserInfoActivity extends Activity {
		...
		private 			View 					userinfo_body_base_1_head;
		private 			View 					userinfo_body_base_1_name;
		@Override
		protected void onCreate(Bundle savedInstanceState) {
			...
			userinfo_body_base_1_head = findViewById(R.id.userinfo_body_base_1_head);
			userinfo_body_base_1_name = findViewById(R.id.userinfo_body_base_1_name);
			int len = 0;
			...
			userinfo_body_base_1_head.setLayoutParams(params);
			params = new LayoutParams( (int) ((len-40)*(2.0f/3.0f)), ( len - 40 )/3 );
			params.setMargins(20, 10, 20, 10);
			userinfo_body_base_1_name.setLayoutParams(params);
		}
		@Override
					...
					try {
						...
						if ( 0 == jsonObject.getInt("error") )
						{
							...
							if( dataObject.getInt("isfamily") == 1 || 
								dataObject.getString("uid").equals(UserInfoManager.getInstance(UserInfoActivity.this).getItem("uid").getValue())
								)
							{
