...
public class GuidActivity extends Activity implements OnPageChangeListener {
	...
	private static final int[] pics_l = { R.drawable.guiding1_l,
		   R.drawable.guiding2_l, R.drawable.guiding3_l,
		   };
			...
			if( v == list.get(list.size()-1))
			{
				...
				animation.setAnimationListener(new AnimationListener() {
					...
					public void onAnimationEnd(Animation animation) {
						...
						if( getIntent().getBooleanExtra("showGuid", false) )
						{
