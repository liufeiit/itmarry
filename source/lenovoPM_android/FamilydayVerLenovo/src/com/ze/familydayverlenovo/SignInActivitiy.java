...
import com.ze.familydayverlenovo.R.string;
...
//				Toast.makeText(SignInActivitiy.this, R.string.notopen, Toast.LENGTH_SHORT).show();
				Intent intent = new Intent();
				intent.setClass(SignInActivitiy.this, GuidActivity.class);
				intent.putExtra("showGuid", true);
...
//							}
							...
							Componet authC = (UserInfoManager.getInstance(SignInActivitiy.this)
									.getItem("m_auth"));
							if (authC != null){
								WidgetDataMrg.M_AUTH = authC.getValue();
							}
							Intent intent = new Intent();
							intent.setClass(SignInActivitiy.this, MainActivity.class)	;
