...
//	            ((Activity)context).finish();
        ...
        {
        	   Intent mIntent = new Intent(context, PhotoShowActivity.class);
...
//               ((Activity)context).finish();
   ...
   private void showAction(String str){
		...
		try {
			...
			if (idtype.equals("photoid")){
				WidgetDataMrg.pushJSON.put("id", obj.getInt("id"));
				WidgetDataMrg.pushJSON.put("uid", obj.getInt("uid"));
				WidgetDataMrg.FLAG_PUSH = true;
			}
