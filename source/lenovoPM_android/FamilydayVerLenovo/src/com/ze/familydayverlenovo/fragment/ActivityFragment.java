...
import com.ze.familydayverlenovo.GaodeMapActivity;
...
public class ActivityFragment extends RelativeLayout  implements RelativeLayoutImp {
	...
	private 	Button 					mButtonEventIntroduce;
	...
	private 	View 						mViewBelowListView;
    ...
    public void setupViews(){  
        ...
        mViewBelowListView = rootView.findViewById(R.id.activity_viewlistviewbelow);
        mViewBelowListView.setOnClickListener(ButtonOnclickListener);
        mHeadView		= LayoutInflater.from((PhotoShowActivity)mContext).inflate(R.layout.activity_listview_head, null);
        ...
        mViewlabel 		= (TextView)mHeadView.findViewById(R.id.activity_label);
        mViewlabel.setOnClickListener(ButtonOnclickListener);
...
//		mTvDetail			= (TextView)mHeadView.findViewById(R.id.activity_detail);
		...
		mTvTopic.setOnClickListener(ButtonOnclickListener);
		mTvName.setOnClickListener(ButtonOnclickListener);
		mTvTime.setOnClickListener(ButtonOnclickListener);
		mTvEncourage.setOnClickListener(ButtonOnclickListener);
		mTvEventPlace.setOnClickListener(ButtonOnclickListener);
		mTvEventTime.setOnClickListener(ButtonOnclickListener);
//		mButtonEventIntroduce 		= (Button)mHeadView.findViewById(R.id.activity_content_layout_button);
//		mButtonEventIntroduce.setOnClickListener(ButtonOnclickListener);
        addView(rootView);  
