...
//	private 	ImageView 				mblog_content;
    ...
    public void setupViews(){  
        ...
        mViewBelowListView = rootView.findViewById(R.id.blog_viewlistviewbelow);
		...
		mTvToblog.setOnClickListener(ButtonOnclickListener);
...
//		mTvHtml			= (TextView)mHeadView.findViewById(R.id.blog_content_layout);
		...
		mTvHtml.setOnClickListener(ButtonOnclickListener);
		mBtnHtml 		= (Button)mHeadView.findViewById(R.id.blog_content_layout_button);
		mBtnHtml.setOnClickListener(ButtonOnclickListener);
