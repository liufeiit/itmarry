...
public class UpdateManager {
	...
	// 存放更新APK文件的路径
	public static final String UPDATE_DOWNURL = "http://dyj.ntcome.com/update/dyj.apk";
	// 存放更新APK文件相应的版本说明路径
	public static final String UPDATE_CHECKURL = "http://dyj.ntcome.com/update/update_verson.txt";
	public static final String UPDATE_APKNAME = "dyj.apk";
	// public static final String UPDATE_VERJSON = "ver.txt";
	public static final String UPDATE_SAVENAME = "dyjapk.apk";
	...
	// 从服务器上下载apk存放文件夹
	private String savefolder = "/innerDisk/";
				...
				try {
					...
					if (array.length() > 0) {
						...
						try {
							...
							updateInfo = obj.getString("verInfo");
							Log.i("newVerCode",
									newVersionCode
											+ "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
							Log.i("newVerName",
		...
		new Thread() {
			...
			public void run() {
				try {
					...
					savefolder = sd.getPath() + savefolder;
