...
public class RefreshListView extends ListView implements OnScrollListener {
    ...
    void init(final Context context) {
        ...
        Log.i("top is:",mHeaderLinearLayout.getTop()+"");
        Log.i("Bottom is:",mHeaderLinearLayout.getBottom()+"");
        //mHeaderLinearLayout.setBottom(0);
        ...
        Log.i("mHeaderHeight is :",mHeaderHeight+"");
