...
{
data.enforceInterface(DESCRIPTOR);
boolean _result = this.cancelMissedCallsNotification();
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
static final int TRANSACTION_cancelMissedCallsNotification = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_disableDataConnectivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_isDataConnectivityPossible = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
}
/**      
  * End call or go to the Home screen
  * @return whether it hung up     
