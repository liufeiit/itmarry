...
import com.itjiehun.fan.umeng.UmengStatic;
import com.itjiehun.fan.waps.WapsStatic;
...
public class MainActivity extends Activity {
	...
	protected void onPause() {
		super.onPause();
		save();
		MobclickAgent.onPageEnd("FanSplashScreen");
	...
	protected void onResume() {
		super.onResume();
		load();
		MobclickAgent.onPageStart("FanSplashScreen");
