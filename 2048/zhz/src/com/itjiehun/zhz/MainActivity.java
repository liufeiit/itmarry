...
import com.itjiehun.zhz.umeng.UmengStatic;
import com.itjiehun.zhz.waps.WapsStatic;
...
//		AppConnect.getInstance(this).showOffers(this);
	...
	protected void onPause() {
		super.onPause();
		save();
		MobclickAgent.onPageEnd("ZhzSplashScreen");
	...
	protected void onResume() {
		super.onResume();
		load();
		MobclickAgent.onPageStart("ZhzSplashScreen");
